...
/*
 * This class is a suport for date handling 
 */
public class DatePicker {

	private final String dateFormat = "dd MMMM yyyy";
	private final CoreQA driver;
	...
	public DatePicker(CoreQA driver) {
		this.driver = driver;
	}
	...
	public void setDate(String date) {
		...
		// select the date
		driver.getElements(dates, "css").stream().filter(ele -> Integer.parseInt(ele.getText()) == day).findFirst()
